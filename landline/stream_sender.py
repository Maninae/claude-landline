...
from landline.tool_status import _format_repeated_status
...
class StreamSender:
    ...
    def _record_emit_failure(self, exc: BaseException) -> None:
        ...
        # path in landline.notifications so the alert reaches the operator
        ...
        try:
            from landline import notifications  # local import breaks the cycle
