...
from landline.inject import commit_inject_queue
from landline.logging import log
from landline.state import (
    get_context_percent,
    log_conversation,
...
from landline.telegram_fmt import italic
...
class ClaudeDispatcher:
    ...
    def _maybe_send_auth_expiry_alert(self) -> None:
        ...
        if (
            ...
            return
        try:
            from landline.notifications import send_health_alert
