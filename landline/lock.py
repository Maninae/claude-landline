...
# `patch("landline.lock.keychain_get", ...)` — the patch site stays alive so the
...
# to `landline.lock.keychain_get_status`.
from landline.security import keychain_get, keychain_get_status  # noqa: F401
